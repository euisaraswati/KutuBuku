...
<div id="head">
	<div class="hdkiri">
	<a href="index.php">Kutu<b>Buku</b>.com</a>
	</div>
	<div class="hdkanan">
	<form>
...
<div id="menu">
	<div class="menukiri">
		<b style="padding:20px;line-height:70px;font-size:20px;color:#fff;">Aplikasi Toko Buku online (KutuBuku.com)</b>
	</div>
	<div class="menukanan">
	<ul>
